...
inline Casita3::Casita3(int x, int y) :Casita(c1, c2, c3, c4, x, y, 5, 5, true, x1, y1, x2, y2, x3, y3, x4, y4, x5, y5)
{
	Random rA;
	x = x;
	y = y;
...
inline Casita3::~Casita3() {}
inline void Casita3::crearPuerta(Graphics^ r) {
	SolidBrush^ myBrush = gcnew SolidBrush(Color::FromArgb(c4, c2, c2));
	r->DrawRectangle(Pens::Black, x2 + 15, y2 + 15, 25, 35);
	r->FillRectangle(myBrush, x2 + 15, y2 + 15, 25, 35);

}
inline void Casita3::crearParedes(Graphics^ r) {
	SolidBrush^ myBrush = gcnew SolidBrush(Color::FromArgb(c1, c3, c3));
	r->DrawRectangle(Pens::Black, x1, y1, 175, 50);
	r->FillRectangle(myBrush, x1, y1, 175, 50);
	r->DrawLine(Pens::Black, x1 + 75, y1, x1 + 75, y1 + 50);
}
inline void Casita3::crearVentana(Graphics^ r) {
	SolidBrush^ myBrush = gcnew SolidBrush(Color::FromArgb(c3, c4, c3));
	r->DrawRectangle(Pens::Black, x3 + 85, y3 + 15, 50, 15);
	r->FillRectangle(myBrush, x3 + 85, y3 + 15, 50, 15);
}
inline void Casita3::crearTecho1(Graphics^ r) {
	SolidBrush^ myBrush = gcnew SolidBrush(Color::FromArgb(c4, c3, c4));
...
inline void Casita3::crearTecho2(Graphics^ r) {
