...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->label1->Location = System::Drawing::Point(87, 195);
			this->label1->Name = L"label1";
			this->label1->Size = System::Drawing::Size(532, 33);
			this->label1->TabIndex = 0;
			this->label1->Text = L"U202313915 - Angel Ronaldo Quintanilla Ramos";
			// 
			// label2
			// 
			...
			this->label2->Font = (gcnew System::Drawing::Font(L"Monotype Corsiva", 20.25F, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic)),
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->label2->Location = System::Drawing::Point(113, 250);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(466, 33);
			this->label2->TabIndex = 1;
			this->label2->Text = L"U20231e777 Leicy Cristell Cahuana Lopez";
			// 
			// label3
			// 
			...
			this->label3->Font = (gcnew System::Drawing::Font(L"Monotype Corsiva", 20.25F, static_cast<System::Drawing::FontStyle>((System::Drawing::FontStyle::Bold | System::Drawing::FontStyle::Italic)),
				System::Drawing::GraphicsUnit::Point, static_cast<System::Byte>(0)));
			this->label3->Location = System::Drawing::Point(96, 304);
			this->label3->Name = L"label3";
			this->label3->Size = System::Drawing::Size(523, 33);
			this->label3->TabIndex = 2;
			this->label3->Text = L"U202311258 María Patricia Hernández Uchuya";
			// 
			// CREDITS
			// 
			...
			this->ClientSize = System::Drawing::Size(700, 477);
